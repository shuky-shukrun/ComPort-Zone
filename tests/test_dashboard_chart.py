"""Tests for the dashboard chart page (FR-48/FR-49)."""
...
from ComPort_Zone.ui.dashboard_chart import (
    CHART_SPANS,
    DEFAULT_SPAN_S,
    ChartView,
    DashboardChartPage,
...
def _value_entry() -> DashboardEntry:
...
class DashboardChartPageTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls) -> None:
        cls.qt = QApplication.instance() or QApplication([])
...
class WidgetHexScanTests(unittest.TestCase):
    ...
    def test_no_hex_in_chart_module(self) -> None:
        ...
        self.assertEqual(
            ...
            [],
            msg="dashboard_chart.py must take colors from ThemePalette",
        )
