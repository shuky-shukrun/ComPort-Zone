...
from ComPort_Zone.control_panel_expr import (
    ExpressionError,
...
from ComPort_Zone.control_panel_models import ControlPanelEntry, MAX_EXPRESSION_LENGTH
...
class HelperTests(unittest.TestCase):
    ...
    def test_build_label_resolver(self) -> None:
        entries = [
            ControlPanelEntry(id="a", label="Rail A", command="A?"),
            ControlPanelEntry(id="b", label="rail a", command="B?"),
            ControlPanelEntry(id="c", command="C?"),  # label falls back to command
        ]
