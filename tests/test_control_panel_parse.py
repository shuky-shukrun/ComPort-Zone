"""Tests for control_panel response parsing and color-rule evaluation."""

from __future__ import annotations

import unittest

from ComPort_Zone.control_panel_models import ColorRule, ParseRule
from ComPort_Zone.control_panel_parse import (
    CompiledParseRule,
    MAX_RX_WINDOW_CHARS,
    ParseOutcome,
    append_to_window,
