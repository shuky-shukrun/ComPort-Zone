...
class EntryDialogContext:
    ...
    expressions against sibling entries exactly like the control_panel tab
...
class ControlPanelEntryDialog(QDialog):
    """Create or edit one control_panel entry."""
    ...
    def __init__(
        ...
        *,
        ...
        self._original = entry or ControlPanelEntry()
        ...
        self.mode_combo.addItems(CONTROL_PANEL_SEND_MODES)
        if original.send_mode in CONTROL_PANEL_SEND_MODES:
        ...
        self.target_combo.addItem("Control panel binding (default)", CONTROL_PANEL_DEFAULT_TARGET)
        ...
        self.preview_host.setObjectName("controlPanelPreviewStrip")
        ...
        self.error_label.setObjectName("controlPanelEntryErrors")
    ...
    def _refresh_preview(self) -> None:
        ...
        the user sees exactly what the control_panel will add."""
    ...
    def _enum_options_from_table(self):
        from ...control_panel_models import EnumOption
    ...
    def values(self) -> ControlPanelEntry:
