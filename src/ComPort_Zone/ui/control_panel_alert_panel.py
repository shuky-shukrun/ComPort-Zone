"""Floating alert history popup for one control_panel (FR-58).

Anchored top-right against the control_panel tab and shown when the user
...
from ..control_panel_alerts import ALERT_KIND, AlertLog, AlertRecord
from ..icons import set_button_icon


class AlertHistoryPanel(QFrame):
    """Lightweight floating list of one control_panel's alert events."""
    ...
    def __init__(self, anchor: QWidget, parent: QWidget | None = None) -> None:
        ...
        self.setObjectName("controlPanelAlertPanel")
        self._anchor = anchor
        self._margin = 10
        ...
        self.title_label.setObjectName("controlPanelAlertPanelTitle")
        self.subtitle_label = QLabel("", self)
        self.subtitle_label.setObjectName("controlPanelAlertPanelSubtitle")
        self.clear_button = QToolButton(self)
        self.clear_button.setObjectName("controlPanelAlertPanelButton")
        self.clear_button.setText("Clear")
        self.clear_button.setCursor(Qt.CursorShape.PointingHandCursor)
        self.clear_button.clicked.connect(self.clearRequested)
        self.close_button = QToolButton(self)
        self.close_button.setObjectName("controlPanelAlertPanelButton")
        ...
        self.list_widget.setObjectName("controlPanelAlertList")
