"""Large-format chart page for one control_panel entry (FR-48/FR-49).
...
:class:`ControlPanelTabWidget`; the tab opens it on tile double-click or
the tile's "Open Chart…" menu, hands a fresh sample list in via
:meth:`ControlPanelChartPage.set_history` at ~10 Hz while it is visible,
...
Requirements: docs/control_panel-view-requirements.md (FR-48, FR-49, FR-62).
"""
...
# Qt-free shell over control_panel_history.
PAD_LEFT = 56
PAD_RIGHT = 16
PAD_TOP = 16
PAD_BOTTOM = 36
...
class ChartView(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        self.setObjectName("controlPanelChartView")
...
class ControlPanelChartPage(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        super().__init__(parent)
        self.setObjectName("controlPanelChartPage")
        self._entry_id: str = ""

        self.back_button = QPushButton("← Back", self)
        self.back_button.setObjectName("controlPanelChartBack")
        self.back_button.setCursor(Qt.CursorShape.PointingHandCursor)
        self.back_button.clicked.connect(self.backRequested)

        self.title_label = QLabel("", self)
        self.title_label.setObjectName("controlPanelChartTitle")
        ...
        self.readout_label.setObjectName("controlPanelChartReadout")
    ...
    def set_entry(self, entry: ControlPanelEntry) -> None:
