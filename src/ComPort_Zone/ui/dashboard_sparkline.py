...
:mod:`dashboard_history`, and a short repaint draws an antialiased
...
Requirements: docs/dashboard-view-requirements.md (FR-46, FR-47, NFR-1).
"""
...
from ..dashboard_history import Sample, downsample_minmax
...
class SparklineWidget(QWidget):
    ...
    def set_samples(self, samples: list[Sample], color: str, *, now: float) -> bool:
        ...
        verdict pipeline; ``now`` is the dashboard's monotonic clock so
