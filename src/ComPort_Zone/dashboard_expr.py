"""Safe arithmetic expressions for derived dashboard tiles (FR-61).
...
the dashboard's current entries: the catalog regenerates entry ids on
...
from .dashboard_models import MAX_EXPRESSION_LENGTH
