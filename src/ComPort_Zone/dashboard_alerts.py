"""Alert detection and history for dashboard tiles (FR-57/FR-58).
...
Qt-free by design (enforced via ``core/dashboard.py`` re-exports); the
...
class AlertLog:
    """Bounded per-dashboard alert history with an unseen counter."""
